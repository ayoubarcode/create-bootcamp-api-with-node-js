...
const ManageCourse = (props) => {
  ...
  if (loading || courses === null)  return <Preload />;
              ...
              <div className="card mb-3">
                <div className="row no-gutters">
                  <div className="col-md-4">
                    <img
                      src={current && `/uploads/${current.photo}`}
                      className="card-img"
                      alt="..."
                    />
                  </div>
                ...
                {courses && courses.length > 0 ? (
                  <table className="table  table-hover">
                    ...
                    <caption>
                      <p>
                        {' '}
                        Total {courses.length > 1 ? `courses` : `course`}:{' '}
                        {courses.length}
                      </p>
                    </caption>
                  </table>
                ) : (
                  <p className="mb-4">No courses !</p>
                )}
              </div>
            </div>
          </div>
